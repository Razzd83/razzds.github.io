# [RAG quickstart](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/rag-engine/rag-quickstart.md.txt)
...
> RagManagedDb](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/rag-engine/understanding-ragmanageddb).
...
1. [Install the Agent Platform SDK for Python](https://docs.cloud.google.com/vertex-ai/docs/start/install-sdk).
...
1. Create a RAG corpus.
   ...
   example](https://docs.cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.ragCorpora/create).
2. Import a RAG file.
   ...
   example](https://docs.cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.ragCorpora.ragFiles/import).
3. Run a RAG retrieval query.
   ...
   API](https://docs.cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations/retrieveContexts).
4. Generate content.
