# [Multimodal datasets](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/capabilities/datasets.md.txt)
...
When you tune a model or run a batch prediction job, you are billed for [Generative AI usage](https://docs.cloud.google.com/vertex-ai/generative-ai/pricing) and querying the dataset in [BigQuery](https://cloud.google.com/bigquery/pricing).
