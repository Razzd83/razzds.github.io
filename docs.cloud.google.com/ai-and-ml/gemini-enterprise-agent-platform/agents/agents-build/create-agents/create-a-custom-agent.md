# [Create a custom agent](https://docs.cloud.google.com/gemini-enterprise-agent-platform/build/runtime/create-a-custom-agent.md.txt)
...
`CLASS_NAME` variable a value such as `MyAgent`):
    ...
    class CLASS_NAME:
        ...
        def set_up(self):
            ...
            https://docs.cloud.google.com/python/docs/reference/vertexai/latest.init(project=self.project, location=self.location)
